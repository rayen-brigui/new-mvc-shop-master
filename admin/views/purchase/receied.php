            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="admin.php?controller=purchase&action=Receied">Received</a></li>
                    </ul>
                                 ...
                                 <ul class="comment-reply list-unstyled">
                                     <?php foreach ($orderDetail as $product) : ?>
                                         <li>
                                             ...
                                             <div class="text-box">
                                                 <h5><a style="color: #000;" href="product/<?= $product['product_id']; ?>-<?= $product['slug']; ?>"><?= number_format($product['product_price'], 0, ' ,', '.') ?>d</a><span style="float: right;"><?= $status[$order['status']] ?></span></h5>
