                         ...
                         <div class="card">
                             <div class="body">
                                 <ul class="comment-reply list-unstyled">
                                     <?php foreach ($orderDetail as $product) : ?>
                                         <li>
                                             ...
                                             <div class="text-box">
                                                 ...
                                                 <a style="padding-left: 20px;" href="product/<?= $product['product_id']; ?>-<?= $product['slug']; ?>">Product price: <?= number_format($product['product_price'] , 0, ',', '.') ?>d</a>
                                     ...
                                     <span style="font-size: 1.2em; float: right; padding-left: 25px; padding-right: 25px;"><b><a style="color: #fff" title="Total" class ="btn btn-primary btn-round"><i class="zmdi zmdi-money"></i> Total amount: <?= number_format($order['cart_total'], 0, ',', '. ') ?>d</a></b></span>
                                     <span>
                                     ...
                                     <?php if ($order['status'] == 3 || $order['status'] == 1 || $order['status'] == 2) { ?>
                                         <span> <a href="admin.php?controller=feedback&action=add&order_id=<?= $order['id'] ?>" style="text-decoration: none;" class='btn btn-success waves-effect'>Respond to this order</a></span>
