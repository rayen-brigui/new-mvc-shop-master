                    ...
                    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=comment&action=edit" enctype="multipart/form-data" role="form">
                       ...
                       <h4 class="card-inside-title" style="font-weight:bold;">Content:</h4>
                         <div class="row clearfix">
                             <div class="col-sm-12">
                                 <div class="form-group">
                                     <textarea name="subject" type="text" class="form-control" id="ckeditor" required placeholder="Response content..."><?= $comment ? $comment['content'] : ''; ?></textarea>
                                 </div>
                            </div>
                        </div>
                        <h4>Status:</h4>
                        ...
                        <div class="form-group" style="text-align: center;">
                          <button class="btn btn-primary waves-effect" type="submit">Update feedback</button>
                             <a class="btn btn-warning waves-effect" href="admin.php?controller=comment">Back</a>
                        </div>
                    </form>
                </div>
            </div>
