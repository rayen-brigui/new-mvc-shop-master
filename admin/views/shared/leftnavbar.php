<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.php"><img src="admin/themes/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">MW Jewls</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li class="open"><a href="<?= PATH_URL ?>home" target="_blank"><i class="zmdi zmdi-home"></i><span>Return to SHOP</span></a></li>
            ...
            <li <?= $yourPurchaseNav ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Your Purchase</span></a>
                <ul class="ml-menu">
                   ...
                   <li><a href="admin.php?controller=purchase&action=confirmed">Application confirmed</a></li>
                     <li><a href="admin.php?controller=purchase&action=delivery">Order in transit</a></li>
                     <li><a href="admin.php?controller=purchase&action=receied">Order received</a></li>
                     <li><a href="admin.php?controller=purchase&action=cancelled">Order canceled</a></li>
                </ul>
            </li>
            <?php if ($userInfoNav['role_id'] != 0) :
                if ($userInfoNav['role_id'] == 1) : ?>
                    <li <?= $navCategory ?? ''; ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Category management</span></a>
                        <ul class="ml-menu">
                             <li><a href="admin.php?controller=shop">1. Category group</a></li>
                             <li><a href="admin.php?controller=shop&amp;action=edit">2. Add new category group</a></li>
                             <li><a href="admin.php?controller=category">3. Subcategory</a></li>
                ...
                <li <?= $productNav ?? '' ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-collection-text"></i><span>Product Management</span></a>
                     <ul class="ml-menu">
                         ...
                         <li><a href="admin.php?controller=product&action=update">Newly updated products</a></li>
               ...
               <li <?= $orderNav ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Order management</span></a>
                     <ul class="ml-menu">
                         <li><a href="admin.php?controller=order">List All Orders</a></li>
                         <li><a href="admin.php?controller=order&amp;action=order-noprocess">Unprocessed orders</a></li>
                         <li><a href="admin.php?controller=order&amp;action=order-inprocess">Order in process</a></li>
                         <li><a href="admin.php?controller=order&amp;action=order-complete">Order processed</a></li>
                         <li><a href="admin.php?controller=order&amp;action=order-cancell">Order has been canceled</a></li>
                     </ul>
                 </li>
