                        ...
                        <ul class="menu list-unstyled">
                            <li>
                                <a href="javascript:void(0);">
                                    ...
                                    <div class="menu-info">
                                        <h4>There are <?= $users_online_total ?> users currently accessing</h4>
                                    </div>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="admin.php?controller=order&action=order-noprocess">
                                    ...
                                    <div class="menu-info">
                    <h4><?= $total_order_noprosess ?> New order</h4>                  
                     <p><i class="zmdi zmdi-time"></i> <?= getTime($order_new['createtime'], gmdate('Y:m:d H:i:s', time() + 7 * 3600)) ?> </p>
                            ...
                            <li>
                                <a href="admin.php?controller=order&action=order-cancell">
                                    ...
                                    <div class="menu-info">
                                       <h4>There was an order <b>cancelled</b></h4>
                            ...
                            <li>
                                <a href="admin.php?controller=user&action=info&user_id=<?= $user_update['id'] ?>">
                                    ...
                                    <div class="menu-info">
                                       <h4><b><?= $user_update['user_name'] ?></b> Just updated your account</h4>
