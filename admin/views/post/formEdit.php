        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   ...
                   <strong><?= $post ? 'Warning: </strong> You are in the edit page of the post "' . $post['post_title'] . '", Be careful!!! <a target="_blank" href="#"> See documentation</a>' : 'Warning: </strong> You are in the page of creating a new page, Be careful!!! <a target="_blank" href="#"> See documentation</a>'; ?>
