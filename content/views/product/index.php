                    ...
                    <div class="col-md-6">
                        <div class="summary entry-summary">
                            ...
                            <form enctype="multipart/form-data" method="post" class="cart"
                             ...
                             <hr class="tall">
                             <div class="feedback">
                                 <a href="index.php?controller=feedback&action=index&product_id=<?= $product['id'] ?>"><b>Press
                                         Go here</b></a> to submit feedback on this product.
                             </div>
                         </div>
                     </div>
                 </div>
...
Discount                                                </th>
                                            ...
                                            <form action="index.php?controller=comment" id="submitReview" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <?php if (isset($userNav)) : ?>
                                                                <label>You are logged in with the account <strong><?= $userLogin['user_name'] ?></strong>. You want to <a href="admin.php?controller=home&action=logout">log out</a> ?</label>
                                                             <?php else : ?>
                                                                 <label>Do you want to <strong><a href="admin.php?controller=home&action=login">log in</a></strong> to comment using your account.!</label>
                                                             <?php endif; ?>
                                                             <textarea maxlength="5000" data-msg-required="Please enter your message." rows="10" class="form-control" name="content" id="message" placeholder="Enter your comment or message or comment about the product ......"></textarea>
                                                         </div>
                                                     </div>
                                                 </div>
                                                 <div class="row">
                                                     <div class="col-md-12">
                                                         <input type="submit" value="Submit confirmation" class="btn btn-primary" data-loading-text="Loading...">
                                                    </div>
                                                </div>
                                            </form>
                ...
                <div class="row">
                    <div class="col-md-12">
                       <h2>Products <strong>Related categories</strong></h2>
                    </div>
