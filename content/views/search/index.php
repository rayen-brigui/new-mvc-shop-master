            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div><?php if (empty($products)) { ?>
                         <h3 class="col-sm-12">No matching results were found for the above keyword.</h3>
                         <?php } else { ?><h3 class="col-sm-12">There are a total of <?= $totalRows ?> matches for the word
                                 key "<?= $keyword ?>".</h3><?php } ?></div>
                    <hr class="tall">
