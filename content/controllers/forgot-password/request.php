...
if (!empty($_POST['email'])) {
    ...
    if (!preg_match("/([a-z0-9_]+|[a-z0-9_]+\.[a-z0-9_]+)@(([a-z0-9]|[a-z0-9]+\.[a-z0-9]+)+\.([a-z]{2,4}))/i", $email)) {
        echo "<div style='padding-top: 200px' class='container'><div style='text-align: center;' class='alert alert-danger'><strong>NO!</strong> This email is not valid. Please enter another email. <a href='javascript: history.go(-1)'>Back</a> or <a href='index.php'>Go to Home Page</a></div></div>";
         ...
         echo "<div style='padding-top: 200px' class='container'><div style='text-align: center;' class='alert alert-danger'><strong>NO!</strong> This email has no user and does not exist in the server. Please select another email <a href='javascript: history.go(. -1)'>Back</a> or <a href='index.php'>Go to Home Page</a></div></div>";
         require('content/views/forgot-password/result.php');
        exit;
    } else {
        $option = [
